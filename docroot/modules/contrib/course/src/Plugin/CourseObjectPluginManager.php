...
use Drupal\course\Annotation\CourseObject;
use Traversable;

/**
 * Provides the Course object access plugin manager.
 */
class CourseObjectPluginManager extends DefaultPluginManager {
  ...
  public function __construct(Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $this->alterInfo('course_object_info');
    $this->setCacheBackend($cache_backend, 'course_object_plugins');
  }
